...
I chose to focus on the AudioBook Playlist. I picked it because it seems like
the easiest to implement but is still something I'm interested in since I love
books/audiobooks. I might go back and do the Game character in my free time
since thats the one I'm most interested in but with my schedule I think the
playlist is the most reasonable.
...
- Changed design to include ...
  Added javadoc comments and method documentation. I also gave an example in the
  main method of how information would be input/read using the created methods.
